...
> **데이터**: ImageNet (서버 절대경로 예: `/workspace/etri_iitp/JS/efficientvit2026/data/imagenet`)
...
CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node=1 --master_port=12345 \
  applications/efficientvit_cls/train_efficientvit_cls_model.py \
    ...
    --path /workspace/etri_iitp/JS/efficientvit2026/output/b1_baseline \
    --amp bf16 \
    --wandb \
...
CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node=1 --master_port=12345 \
  applications/efficientvit_cls/train_efficientvit_cls_model.py \
    applications/efficientvit_cls/configs/imagenet/efficientvit_b1.yaml \
    --path /workspace/etri_iitp/JS/efficientvit2026/output/b1_prune50 \
    --amp bf16 \
...
CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node=1 --master_port=12345 \
  applications/efficientvit_cls/train_efficientvit_cls_model.py \
    applications/efficientvit_cls/configs/imagenet/efficientvit_b1.yaml \
    --path /workspace/etri_iitp/JS/efficientvit2026/output/b1_prune75 \
    --amp bf16 \
...
python applications/efficientvit_cls/reduce_efficientvit_cls_model.py \
    --model efficientvit-b1 \
    --checkpoint /workspace/etri_iitp/JS/efficientvit2026/output/b1_prune30/checkpoint/model_best.pt \
    --output    /workspace/etri_iitp/JS/efficientvit2026/output/b1_prune30/reduced_b1_30pct.pt
```
...
python applications/efficientvit_cls/measure_memory.py \
    --model efficientvit-b1 \
    --checkpoint /workspace/etri_iitp/JS/efficientvit2026/output/b1_baseline/checkpoint/model_best.pt

# 3) 원본 vs Reduced 비교 (이미 reducing 된 결과 파일이 있을 때)
python applications/efficientvit_cls/measure_memory.py \
    --model efficientvit-b1 \
    --reduced /workspace/etri_iitp/JS/efficientvit2026/output/b1_prune30/reduced_b1_30pct.pt \
    --per-stage
